...
function PaginatedListClient({ type, title, withCta = false }) {
    ...
    const fetchItems = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "PaginatedListClient.useCallback[fetchItems]": async (isLoadMore = false)=>{
            ...
            try {
                let query = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$data$2f$supabaseClient$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabaseClient"].from(table).select(type === "treatment" ? `*, hospitals(slug, name, location:${locCol})` : `*, location:${locCol}`).range(from, to);
...
//# sourceMappingURL=_46aa54d2._.js.map