                ...
                <form onSubmit={handleLogin} className="space-y-6">
                    ...
                    <div>
                        <div className="flex justify-between items-center mb-1">
                            ...
                            <button type="button" onClick={() => toast.info("Please contact contact@healo.com to reset your password.")} className="text-xs font-bold text-teal-600 hover:underline">{t("login.forgot", langCode)}</button>
                        </div>
                        <div className="relative">
