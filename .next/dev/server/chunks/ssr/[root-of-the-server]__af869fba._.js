...
"[project]/src/lib/i18n/format.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const formatPriceSingle = (value, lang = "en")=>{
    if (value === null || value === undefined) return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$i18n$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["t"])("price.inquire", lang);
...
const formatPriceRange = (min, max, lang = "en")=>{
    ...
    if (hasMin) return `${formatCurrencyUSD(min, lang)}${(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$i18n$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["t"])("price.plus", lang)}`;
    if (hasMax) return `${(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$i18n$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["t"])("price.upTo", lang)} ${formatCurrencyUSD(max, lang)}`;
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$i18n$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["t"])("price.askQuote", lang);
};
...
// src/lib/mapper.js
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$i18n$2f$format$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/i18n/format.js [app-rsc] (ecmascript)");
;
...
const mapTreatmentRow = (t)=>{
    ...
    return {
        ...
        price: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$i18n$2f$format$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["formatPriceRange"])(t.price_min, t.price_max, "en"),
...
const getHospitalBySlug = async (slug)=>{
    if (!slug) return null;
    const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$data$2f$supabaseServer$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["supabaseServer"].from("hospitals").select(HOSPITAL_SELECT).eq("slug", slug).maybeSingle();
    if (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__af869fba._.js.map