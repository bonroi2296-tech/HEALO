            ...
            const run = {
                "HospitalDetailPage.useEffect.run": async ()=>{
                    ...
                    try {
                        ...
                        const { data: hRow, error: hErr } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$supabase$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("hospitals").select(`id,name,location:${locCol},address_detail,description,images,tags,rating,reviews_count,doctor_profile,latitude,longitude,operating_hours`).eq("id", selectedId).maybeSingle();
                        if (hErr) {
                        ...
                        setHospital(h);
                        const { data: tRows, error: tErr } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$supabase$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("treatments").select("id,name,description,images,tags,price_min,hospital_id").eq("hospital_id", selectedId);
                        if (tErr) {
...
"[project]/app/hospitals/[id]/HospitalDetailClient.jsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
//# sourceMappingURL=_d0dfbb38._.js.map